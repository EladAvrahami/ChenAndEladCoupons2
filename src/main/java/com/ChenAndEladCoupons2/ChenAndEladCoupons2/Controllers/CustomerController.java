...
public class CustomerController {
    ...
    //GET ALL COUPONS PER CUSTOMER LOGGED IN
    ...
    public ResponseEntity<?> getCouponsByCustomer2(@PathVariable int id){
        return ResponseEntity.ok (customerService.getOneCustomerCoupons (id));
    }
